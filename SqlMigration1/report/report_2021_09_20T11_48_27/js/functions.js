...
const messageConstants = Object.freeze({
    "command": {
        ...
        "messagesFilterChange": "messages-filter-change"
    }
});
...
function showReportHeader(isReportHeaderExpanded) {
    window.parent.postMessage({ "command": messageConstants.command.toggleView, "section": "reportHeader", "state": isReportHeaderExpanded }, "*");
}
...
function showTree(isTreeExpanded) {
    window.parent.postMessage({ "command": messageConstants.command.toggleView, "section": "tree", "state": isTreeExpanded }, "*");
}
...
function showMessages(isMessagesExpanded) {
    window.parent.postMessage({ "command": messageConstants.command.toggleView, "section": "messages", "state": isMessagesExpanded }, "*");
}
 ...
 */
function toggleAll() {
    window.parent.postMessage({ "command": messageConstants.command.toggleView, "section": "all", "state": true }, "*");
}
